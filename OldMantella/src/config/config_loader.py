...
class ConfigLoader:
    ...
    def __update_config_values_from_current_state(self):
        ...
        try:
            ...
            self.max_radiant_duration = self.__definitions.get_int_value("max_radiant_duration")
...
LLM parameter list must follow the Python dictionary format: https://www.w3schools.com/python/python_dictionaries.asp""")
            ...
            self.image_transcription_prefix = self.__definitions.get_string_value("image_transcription_prefix")

...
class LLMDefinitions:
    ...
    @staticmethod
    def get_max_radiant_duration_config_value() -> ConfigValue:
        description = "The maximum duration in seconds for radiant conversations between NPCs. After this time has elapsed, the conversation will naturally end. Lower values create shorter conversations, higher values allow longer dialogues. Set to 0 for unlimited duration."
        return ConfigValueInt("max_radiant_duration","Max Radiant Conversation Duration (seconds)", description, 60, 0, 600, tags=[ConfigValueTag.advanced])

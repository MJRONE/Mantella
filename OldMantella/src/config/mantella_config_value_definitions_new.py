...
class MantellaConfigValueDefinitionsNew:
    ...
    def get_config_values(is_integrated: bool, actions: list[Action], on_value_change_callback: Callable[..., Any] | None = None) -> ConfigValues:
        ...
        llm_category.add_config_value(LLMDefinitions.get_max_radiant_duration_config_value())
        ...
        vision_category.add_config_value(VisionDefinitions.get_image_transcription_prefix_config_value())

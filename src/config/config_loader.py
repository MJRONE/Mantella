...
LLM parameter list must be valid JSON""")
            ...
            self.radiant_player_interrupt = self.__definitions.get_bool_value("radiant_player_interrupt")
            self.radiant_force_refresh_interval = self.__definitions.get_int_value("radiant_force_refresh_interval")
